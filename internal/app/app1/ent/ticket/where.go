...
func TokenIn(vs ...string) predicate.Ticket {
...
func TokenNotIn(vs ...string) predicate.Ticket {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExpiresAtIn(vs ...time.Time) predicate.Ticket {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExpiresAtNotIn(vs ...time.Time) predicate.Ticket {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
